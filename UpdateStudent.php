...
<?php
	...
	if(isset($_POST['btnEdit'])){
		$new_rollno=mysqli_real_escape_string($con,$_POST['rollno']);
		$new_firstname=mysqli_real_escape_string($con,$_POST['firstname']);
		$new_middlename=mysqli_real_escape_string($con,$_POST['middlename']);
		...
		$new_pcno=mysqli_real_escape_string($con,$_POST['pcno']);
		$new_course=mysqli_real_escape_string($con,$_POST['course']);
		$new_courseid=mysqli_real_escape_string($con,$_POST['courseid']);
		$new_semname=mysqli_real_escape_string($con,$_POST['semname']);
		$new_aadhaar=mysqli_real_escape_string($con,$_POST['aadhaar']);
		$new_caste=mysqli_real_escape_string($con,$_POST['caste']);
		$new_lqualify=mysqli_real_escape_string($con,$_POST['lqualify']);
		$new_status=mysqli_real_escape_string($con,$_POST['status']);
		
		$sqlupdate="UPDATE student SET EnrollmentNo='$new_rollno', Firstname='$new_firstname', Middlename='$new_middlename', Lastname='$new_lastname', Address='$new_address', SemName='$new_semname', Email='$new_email', PhoneNo='$new_phoneno', 
					PCNo='$new_pcno', DOB='$new_dob', Caste='$new_caste', Gender='$new_gender', AadhaarNo='$new_aadhaar', Course='$new_course',CourseID='$new_courseid', LastQualification='$new_lqualify', Status='$new_status'
					WHERE EnrollmentNo='$new_rollno'";
	...
	if(isset($_GET['delete'])){
		$id=$_GET['delete'];
		$sqldelete="DELETE FROM student WHERE EnrollmentNo='$id'";
