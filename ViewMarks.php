		...
		<main class="page-content">
			<div id="newr">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card">
						<h3 class="card-header">Students Marks</h3>
						<h5 class="card-header">
							<FONT> COURSE: <?PHP echo $CO; ?></FONT>
							<FONT>&nbsp &nbsp &nbsp </FONT>
							<FONT> SEMESTER: <?PHP echo $SE; ?></FONT>
							<FONT>&nbsp &nbsp &nbsp </FONT>
							<FONT> SUBJECT: <?PHP echo $SU; ?>
						</h5>
						<div class="card-body">
							<div class="table-responsive">
								<table id="studmarks_data" class="table table-bordered table-striped ">
									<thead>
										<tr>
											<th>Enrollment No</th>
											<th>PA1</th>
									...
									<tbody>
										...
										<?php
										$query = "SELECT * FROM marksheet2 WHERE CourseID = '$cs' AND SemID='$sm' AND SubjectID = '$sb'";
