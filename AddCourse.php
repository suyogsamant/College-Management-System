        ...
        $(document).ready(function () {
            $('#submit').click(function () {
                ...
                if (courseid == '' || coursename == '') {
                    ...
                    $.ajax({
                        method: "POST",
                        data: { ajax: 1, courseid: courseid, coursename: coursename },
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <form id="submit_form" action="" method="POST">
                            <label><h5>Course ID:</h5></label>
                            <input type="text" courseid="courseid" id="courseid" class="form-control form-rounded" />
                            <br />
                            <label><h5>Course Name:</h5></label>
                            <input type="text" name="coursename" id="coursename" class="form-control form-rounded" />
                            <br />
